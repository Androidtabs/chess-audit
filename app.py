...
st.markdown("""
    ...
    /* BOTÕES LATERAIS QUE VOCÊ GOSTOU (MENORES E CIRCULARES) */
    div.stButton > button {
        ...
        margin-top: 200px; /* Alinhamento com o meio do tabuleiro */
    }
...
# Gestão Oculta (Mantida original)
